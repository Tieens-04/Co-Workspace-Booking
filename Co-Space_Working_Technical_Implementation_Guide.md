...
**Tên dự án:** Co-Space Working Management System\
...
**Issue Id:** `1001` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
...
**Issue Id:** `1002` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
...
**Issue Id:** `1003` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
...
**Issue Id:** `1004` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
...
**Issue Id:** `1005` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
...
**Issue Id:** `1006` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
...
-   Booking hôm nay: count theo business timezone; occupancy: booked
    room-minutes / available room-minutes; revenue: chỉ PAID theo Task
    2022.
...
**Issue Id:** `1007` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
...
**Issue Id:** `1008` \| **Parent Id:** *(none)* \| **Labels:**
`co-space`
